...
{
    $output = get_field('opening_hours', 'options');
    return $output;
}
...
add_shortcode('book_now', function () {
...
function social_icons($size = null)
{
    ...
    if ($s['linkedin_url'] ?? null) {
        $output .= '<a href="' . $s['linkedin_url'] . '" target="_blank" aria-label="LinkedIn" class="mb-3"><i class="fa-brands fa-linkedin-in ' . $size . '"></i></a>';
    }
    if ($s['youtube_url'] ?? null) {
        $output .= '<a href="' . $s['youtube_url'] . '" target="_blank" aria-label="LinkedIn" class="mb-3"><i class="fa-brands fa-youtube ' . $size . '"></i></a>';
    }
    if ($s['instagram_url'] ?? null) {
        $output .= '<a href="' . $s['instagram_url'] . '" target="_blank" aria-label="Instagram" class="mb-3"><i class="fa-brands fa-instagram ' . $size . '"></i></a>';
    }
    if ($s['facebook_url'] ?? null) {
        $output .= '<a href="' . $s['facebook_url'] . '" target="_blank" aria-label="Facebook" class="mb-3"><i class="fa-brands fa-facebook-f ' . $size . '"></i></a>';
    }
    if ($s['twitter_url'] ?? null) {
        $output .= '<a href="' . $s['twitter_url'] . '" target="_blank" aria-label="X" class="mb-3"><i class="fa-brands fa-x-twitter ' . $size . '"></i></a>';
    }
    $output .= '</div>';
