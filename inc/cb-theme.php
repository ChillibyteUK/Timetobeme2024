...
function widgets_init()
{
    ...
    register_nav_menus(array(
        'primary_nav' => __('Primary Nav', 'Timetobeme2024'),
        'footer_menu' => __('Footer Nav 1', 'Timetobeme2024'),
        'footer_menu_2' => __('Footer Nav 2', 'Timetobeme2024'),
        'footer_menu_3' => __('Footer Nav 3', 'Timetobeme2024'),
    ));
