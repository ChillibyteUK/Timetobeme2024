        ...
        ?>
            <div class="col-12 col-lg-3 col-md-6 col-sm-6 d-flex flex-column align-self-stretch shadow">
                ...
                <div class="bg-white p-3 h-100">
                    <div class="fw-bold"><? echo wp_kses_post( get_sub_field("title") );?></div>
                    <div class="fw-bold"><? echo wp_kses_post( get_sub_field("position") );?></div>
                    <div class=""><? echo wp_kses_post( get_sub_field("bio") );?></div>
                </div>
            </div>
        <?php
        endif;
